# ICON deployed-code
# NAME Wavy!
# DESC A scrolling wavy rainbow message!
...
message = "Tufty 2350 is a hackable, programmable badge with a TFT LCD colour display, powered by the Raspberry Pi RP2350!"
text_size = 10
